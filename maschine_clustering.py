...
sparkDF = spark.read.options(inferSchema='True',delimiter=',', header='true').csv('trainingsdaten_maschinen_100.csv')
...
specific_cluster = predictions.filter(predictions["prediction"] == 1)
